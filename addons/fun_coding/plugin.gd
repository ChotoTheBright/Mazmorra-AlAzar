...
# Scenes preloaded
const Boom: PackedScene = preload("res://addons/fun_coding/boom.tscn")
const Blip: PackedScene = preload("res://addons/fun_coding/blip.tscn")
const Newline: PackedScene = preload("res://addons/fun_coding/newline.tscn")
const Dock: PackedScene = preload("res://addons/fun_coding/dock.tscn")
const Pet: PackedScene = preload("res://addons/fun_coding/pet.tscn")
...
func _enter_tree():
	...
	#Add the main panel and pet
	dock = Dock.instantiate()
	pet = Pet.instantiate()
	EditorInterface.get_base_control().add_child(pet)
